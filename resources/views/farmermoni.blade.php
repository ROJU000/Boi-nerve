    ...
    <div class="position-relative">
        <div class="row align-items-center justify-content-between">
            <div class="col position-relative">
                <h2 class="text-white">Welcome back, Here's your Farmermoni dashboard!</h2>
                <p class="text-white">You can view Reports, Charts to help gain better insights on Farmermoni </p>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="ftac">{{ $cards[0] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="ftad">{{ $cards[1] }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-top-0 border-bottom-0 border-right-0 border-left-lg border-green h-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="h5" id="ftaid"> {{ $cards[2] }}</div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="ftnpl">{{ $cards[3] }}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-5 col-xl-4 mb-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="chart-area"><canvas id="ftcp" width="100%" height="30"></canvas></div>
            </div>
        ...
        <div class="card bg-success o-visible mb-4">
            <div class="card-body">
                ...
                <p class="text-white-50">This gives an overall summary of the metrics in the Farmermoni programme. Click on the respective legends to see more interaction with the Charts</p>
    ...
    <div class="col-lg-7 col-xl-8 mb-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="chart-area"><canvas id="fbarchart" width="100%" height="30"></canvas></div>
            </div>
            <div class="card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
        <div class="card">
            ...
            <div class="card-body" >
                <div class="chart-area"><canvas id="fBarChart1"></canvas></div>
            </div>
            <div class= "card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
    </div>
...
var ctx = document.getElementById("ftcp").getContext('2d');
...
var ctx1 = document.getElementById("fbarchart");
...
var ctx2 = document.getElementById("fBarChart1");
