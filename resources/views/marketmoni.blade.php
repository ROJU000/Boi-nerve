    ...
    <div class="position-relative">
        <div class="row align-items-center justify-content-between">
            <div class="col position-relative">
                <h2 class="text-white">Welcome back, Here's your Marketmoni dashboard!</h2>
                <p class="text-white">You can view Reports, Charts to help gain better insights on Marketmoni </p>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="mtac">{{ $cards[0] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="mtad">{{ $cards[1] }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-top-0 border-bottom-0 border-right-0 border-left-lg border-green h-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="h5" id="mtaid"> {{ $cards[2] }}</div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="mtnpl">{{ $cards[3] }}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-5 col-xl-4 mb-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="chart-area"><canvas id="mpiechart" width="100%" height="30"></canvas></div>
            </div>
        ...
        <div class="card bg-success o-visible mb-4">
            <div class="card-body">
                ...
                <p class="text-white-50">This gives an overall summary of the metrics in the Marketmoni programme. Click on the respective legends to see more interaction with the Charts</p>
    ...
    <div class="col-lg-7 col-xl-8 mb-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="chart-area"><canvas id="mbarchart1" width="100%" height="30"></canvas></div>
            </div>
            <div class="card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
        <div class="card">
            ...
            <div class="card-body" >
                <div class="chart-area"><canvas id="mBarChart2"></canvas></div>
            </div>
            <div class= "card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
        {{-- <div class="card">
            <div class="card-header">Total Collections per Product</div>
            <div class="card-body" >
                <div class="chart-area"><canvas id="mBarChart3"></canvas></div>
            </div>
            <div class= "card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div> --}}
    </div>
...
var ctx = document.getElementById("mpiechart").getContext('2d');
...
var ctx1 = document.getElementById("mbarchart1");
...
var ctx2 = document.getElementById("mBarChart2");
