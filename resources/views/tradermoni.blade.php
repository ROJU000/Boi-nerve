    ...
    <div class="position-relative">
        <div class="row align-items-center justify-content-between">
            <div class="col position-relative">
                <h2 class="text-white">Welcome back, Here's your Tradermoni dashboard!</h2>
                <p class="text-white">You can view Reports, Charts to help gain better insights on Tradermoni </p>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="ttac">{{ $cards[0] }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="ttad">{{ $cards[1] }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-top-0 border-bottom-0 border-right-0 border-left-lg border-green h-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="h5" id="ttaid"> {{ $cards[2] }}</div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <div class="h5" id="ttnpl">{{ $cards[3] }}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-5 col-xl-4 mb-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="chart-area"><canvas id="tpc" width="100%" height="30"></canvas></div>
            </div>
        ...
        <div class="card bg-success o-visible mb-4">
            <div class="card-body">
                ...
                <p class="text-white-50">This gives an overall summary of the metrics in the Tradermoni programme. Click on the respective legends to see more interaction with the Charts</p>
    ...
    <div class="col-lg-7 col-xl-8 mb-4">
        <div class="card mb-4">
            <div class="card-header">Total Count per Region</div>
            <div class="card-body">
                <div class="chart-area"><canvas id="ttmyBarChart" width="100%" height="30"></canvas></div>
            </div>
            <div class="card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
        <div class="card mb-4">
            <div class="card-header">Tradermoni Tradetype</div>
            <div class="card-body" >
                <div class="chart-area"><canvas id="tmyBarChart" ></canvas></div>
            </div>
            <div class= "card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
        <div class="card">
            ...
            <div class="card-body" >
                <div class="chart-area"><canvas id="ttcp"></canvas></div>
            </div>
            <div class= "card-footer small text"><small>Updated yesterday at @php  echo date('F j, Y', time() ) @endphp</small></div>
        </div>
    </div>
...
{{-- <script src = "assets/demo/geep/chart-area-geep.js"></script>
<script src="assets/demo/geep/chart-bar-geep.js"></script> --}}

<script>

var ctx = document.getElementById("tpc").getContext('2d');
...
// Bar Chart === Total tradetype
var ctx1 = document.getElementById("tmyBarChart");
var myBarChart = new Chart(ctx1, {
    type: "bar",
    data: {
        labels: ["{{ $barcharts['ab'] }}","{{ $barcharts['bb'] }}","{{ $barcharts['cb'] }}","{{ $barcharts['db'] }}","{{ $barcharts['eb'] }}","{{ $barcharts['fb'] }}"],
        datasets: [{
            label: "Total Collections ",
            backgroundColor: [ "rgba(17, 82, 56, 1)", "rgba(255, 136, 0, 1)", "rgba(7, 224, 141, 1)", "rgba(0, 153, 204,1)", "rgba(7, 224, 141, 1)"],
            hoverBackgroundColor:  [ "rgba(17, 82, 56, 0.8)", "rgba(255, 136, 0, 0.8)", "rgba(7, 224, 141, 0.8)"],
            borderColor: "rgba(234, 236, 244, 1)",
            data:  [{{ $barcharts['a'] }},{{ $barcharts['b'] }},{{ $barcharts['c'] }},{{ $barcharts['d'] }},{{ $barcharts['e'] }},{{ $barcharts['f'] }}],
        }]
    },
    options: {
        maintainAspectRatio: false,
...
var ctx2 = document.getElementById("ttcp");
...
/// bar chart displaying count per region ///

var ctx1 = document.getElementById("ttmyBarChart");
var myBarChart = new Chart(ctx1, {
    type: "bar",
    data: {
        labels: ["{{ $barchart2['ab'] }}","{{ $barchart2['bb'] }}","{{ $barchart2['cb'] }}","{{ $barchart2['db'] }}","{{ $barchart2['eb'] }}","{{ $barchart2['fb'] }}"],
        datasets: [{
            label: "Total Collections ",
            backgroundColor: [ "rgba(17, 82, 56, 1)", "rgba(255, 136, 0, 1)", "rgba(7, 224, 141, 1)", "rgba(255, 102, 0, 1)", "rgba(0, 153, 204,1)", "rgba(7, 224, 141, 1)"],
            hoverBackgroundColor:  [ "rgba(17, 82, 56, 0.8)", "rgba(255, 136, 0, 0.8)", "rgba(7, 224, 141, 0.8)"],
            borderColor: "rgba(234, 236, 244, 1)",
            data:  [{{ $barchart2['a'] }},{{ $barchart2['b'] }},{{ $barchart2['c'] }},{{ $barchart2['d'] }},{{ $barchart2['e'] }},{{ $barchart2['f'] }}],
        }]
    },
    options: {
        maintainAspectRatio: false,
